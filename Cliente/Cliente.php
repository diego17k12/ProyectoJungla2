...
$sql="SELECT u.id,c.id_usuario,c.nombre,c.apellido,c.cedula,c.telefono
	from cliente c
	join clieusu cu
		  ...
		  <div class="accordion-item">
		    ...
		    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
		      <div class="accordion-body">
		      	...
		      	<a class="btn btn-info" href="../cliente/ActualizarCliente.php?idCliente=<?php echo $resultado[0]["id_usuario"];?>">Actualizar info usuario</a>
		      </div>
		    </div>
		  </div>
		</div>
